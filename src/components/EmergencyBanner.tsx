  ...
  return (
    <section id="emergency" className="py-10 bg-[#FFF8F5] border-b border-[#E5DFD7]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl border-2 border-[#D95A2B]/40 shadow-sm p-6 sm:p-8 lg:p-10 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1C1F22] tracking-tight">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <div className="bg-[#FBF9F5] p-4 rounded-xl border border-[#E5DFD7] flex flex-col justify-start h-full">
                  <div className="flex items-center gap-2 text-[#D95A2B] font-bold text-sm">
                    <span className="w-6 h-6 rounded-full bg-[#D95A2B] text-white flex items-center justify-center text-xs shrink-0">
                      1
                    </span>
            ...
            <div className="lg:col-span-4 bg-[#1C1F22] rounded-xl p-6 text-white text-center flex flex-col items-center justify-center space-y-4 shadow-md">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-2xl sm:text-3xl font-extrabold text-white hover:text-[#D95A2B] transition-colors block mt-1 tracking-tight"
                >
                  {BUSINESS_INFO.phone}
                </a>
              ...
              <a
                href={`tel:${BUSINESS_INFO.phoneClean}`}
                className="w-full bg-[#D95A2B] hover:bg-[#BF491E] text-white py-3 rounded-lg font-bold text-sm flex items-center justify-center gap-2 transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              >
