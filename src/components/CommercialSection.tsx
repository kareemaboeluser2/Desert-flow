  ...
  return (
    <section id="commercial" className="py-16 lg:py-20 bg-white border-b border-[#E5DFD7]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#1C1F22] rounded-2xl sm:rounded-3xl p-5 sm:p-8 lg:p-12 text-white border border-[#282C30] shadow-xl relative overflow-hidden">
          {/* Subtle Grid Accent */}
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-stretch">
            ...
            <div className="lg:col-span-8 space-y-4 sm:space-y-5 flex flex-col justify-between">
              <div>
                ...
                <h2 className="text-xl sm:text-3xl lg:text-4xl font-extrabold text-white tracking-tight mt-3 sm:mt-4">
                  {COMMERCIAL_SERVICE.headline}
                </h2>

                <p className="text-xs sm:text-base text-gray-300 leading-relaxed max-w-2xl font-normal mt-2 sm:mt-3">
            ...
            {/* Right Action Card */}
            <div className="lg:col-span-4 bg-[#282C30] p-5 sm:p-7 rounded-xl sm:rounded-2xl border border-gray-700/70 flex flex-col justify-between space-y-4 sm:space-y-5 h-full">
              <div className="space-y-2 sm:space-y-2.5">
                <div className="flex items-center gap-2 text-[#D95A2B] font-semibold text-xs uppercase tracking-wider">
                  <ShieldCheck className="w-4 h-4 shrink-0" />
                  <span>Licensed & Bonded</span>
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-white">Commercial Dispatch Line</h3>
              ...
              <div className="pt-2 space-y-2.5 sm:space-y-3">
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#D95A2B] hover:bg-[#BF491E] text-white py-3.5 px-4 rounded-xl font-bold text-sm transition-colors shadow-sm min-h-[48px]"
                >
                ...
                <a
                  href="#contact"
                  className="w-full flex items-center justify-center gap-2 bg-transparent hover:bg-white/10 text-white border border-gray-600 py-3 px-4 rounded-xl font-medium text-xs transition-colors min-h-[44px]"
                >
